            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Quản lý lớp học</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Danh sách lớp học</h6>
                </nav>
