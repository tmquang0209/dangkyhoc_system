...
<body class="g-sidenav-show   bg-gray-100">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Quản lý sinh viên</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Quản lý sinh viên</h6>
                </nav>
                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Quản lý sinh viên</p>
                        ...
                        <?php if (isset($_GET["update"])) {
                            ...
                            $id = $_GET["update"];
                            $student = new Student();
                            $getInfo =  $student->getInfo($id);
                        ?>
                            <div class="card-body">
                                <p class="text-uppercase text-sm">Cập nhật thông tin sinh viên <?= $getInfo["student_name"] ?></p>
                                <div id="message"></div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label" id="studentLabel">Mã nhân viên</label>
                                            <input class="form-control" type="text" value="<?= $getInfo["student_code"] ?>" id="studentCode" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Họ và tên</label>
                                            <input class="form-control" type="text" value="<?= $getInfo["student_name"]; ?>" id="studentName">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <script>
                                ...
                                updateBtn.addEventListener("click", function(e) {
                                    ...
                                    if (studentCodeValue && studentCodeValue && studentNameValue && birthdayValue && addressValue && emailValue && mobileNumberValue) {
                                        $.post(`/controller/account.php?updateStudent`, {
                                            ...
                                            setTimeout(() => {
                                                location.href = "/views/student-manager.php"
                                            }, 1000)
                                        });
                                    } else {
                        ...
                        <?php if (isset($_GET["add"])) { ?>
                            <div class="card-body">
                                <p class="text-uppercase text-sm">Thêm mới sinh viên</p>
                                <div id="message"></div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label" id="studentLabel">Mã sinh viên</label>
                                            <input class="form-control" type="text" value="" id="studentCode">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Họ và tên</label>
                                            <input class="form-control" type="text" value="" id="studentName">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <script>
                                ...
                                updateBtn.addEventListener("click", function(e) {
                                    ...
                                    if (studentCodeValue && studentCodeValue && studentNameValue && passwordValue && birthdayValue && addressValue && emailValue && mobileNumberValue) {
                                        $.post(`/controller/account.php?addStudent`, {
                                            studentCode: studentCodeValue,
                                            studentName: studentNameValue,
    ...
    <script>
        ...
        function get() {
            $.post(`/controller/account.php?studentList`).done(function(res) {
                console.log(res);
        ...
        function render(item, index) {
            ...
            <tr>
                ...
                <td><p class="text-xs font-weight-bold mb-0">${item.student_code}</p></td>
                <td class="align-middle text-center text-sm">${item.student_name}</td>
                ...
                <td class="align-middle">
                    <a href="?update=${item.student_code}" data-toggle="tooltip" data-original-title="Edit user">
                        <span class="badge badge-sm bg-gradient-warning">
                            Sửa
                        </span>
                    </a>
                    <br />
                    <a href="?del=${item.student_code}" data-toggle="tooltip" data-original-title="Edit user">
