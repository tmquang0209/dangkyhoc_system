...
<body class="g-sidenav-show   bg-gray-100">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Quản lý nhân sự</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Quản lý nhân sự</h6>
                </nav>
                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                <p class="mb-0">Quản lý nhân sự</p>
                        ...
                        <?php if (isset($_GET["update"])) {
                            ...
                            $id = $_GET["update"];
                            $staff = new Staff();
                            $getInfo =  $staff->getInfo($id);
                            // var_dump($getInfoClass);
                        ?>
                            <div class="card-body">
                                <p class="text-uppercase text-sm">Cập nhật thông tin nhân viên <?= $getInfo["staff_name"] ?></p>
                                <div id="message"></div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label" id="staffLabel">Mã nhân viên</label>
                                            <input class="form-control" type="text" value="<?= $getInfo["staff_code"] ?>" id="staffCode" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Họ và tên</label>
                                            <input class="form-control" type="text" value="<?= $getInfo["staff_name"]; ?>" id="staffName">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <script>
                                ...
                                updateBtn.addEventListener("click", function(e) {
                                    const staffCodeValue = staffCode.value;
                                    const staffNameValue = staffName.value;
                                    const birthdayValue = birthday.value;
                                    const addressValue = address.value;
                                    const emailValue = email.value;
                                    const mobileNumberValue = mobileNumber.value;

                                    if (staffCodeValue && staffCodeValue && staffNameValue && birthdayValue && addressValue && emailValue && mobileNumberValue) {
                                        $.post(`/controller/account.php?updateStaff`, {
                                            ...
                                            setTimeout(() => {
                                                location.href = "/views/staff-manager.php"
                                            }, 1000)
                                        });
                                    } else {
                        ...
                        <?php if (isset($_GET["add"])) { ?>
                            <div class="card-body">
                                <p class="text-uppercase text-sm">Thêm mới nhân viên</p>
                                <div id="message"></div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label" id="staffLabel">Mã nhân viên</label>
                                            <input class="form-control" type="text" value="" id="staffCode">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Họ và tên</label>
                                            <input class="form-control" type="text" value="" id="staffName">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <script>
                                ...
                                updateBtn.addEventListener("click", function(e) {
                                    ...
                                    if (staffCodeValue && staffCodeValue && staffNameValue && passwordValue && birthdayValue && addressValue && emailValue && mobileNumberValue) {
                                        $.post(`/controller/account.php?addStaff`, {
                                            staffCode: staffCodeValue,
                                            staffName: staffNameValue,
    ...
    <script>
        ...
        function get() {
            $.post(`/controller/account.php?staffList`).done(function(res) {
                console.log(res);
        ...
        function render(item, index) {
            ...
            <tr>
                ...
                <td><p class="text-xs font-weight-bold mb-0">${item.staff_code}</p></td>
                <td class="align-middle text-center text-sm">${item.staff_name}</td>
                ...
                <td class="align-middle">
                    <a href="/views/staff-manager.php?update=${item.staff_code}" data-toggle="tooltip" data-original-title="Edit user">
                        <span class="badge badge-sm bg-gradient-warning">
                            Sửa
                        </span>
                    </a>
                    <br />
                    <a href="/views/staff-manager-detail.php?id=${item.staff_code}" data-toggle="tooltip" data-original-title="Edit user">
